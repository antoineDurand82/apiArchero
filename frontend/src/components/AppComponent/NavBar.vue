<template>
  <nav class="navbar">
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto" v-if="isExpanded">
      <router-link to="/dashboard" class="navbar-dashboard-button" >DashBoard</router-link>
    </div>
  </nav>
</template>
...
export default {
  components: {
    IconBow: () => import('@/components/Icon/Bow'),
  },
  data: () => ({
    isExpanded: false,
  }),
