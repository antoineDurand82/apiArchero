...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await db.hero.create({fullName: "Meowgik", attack: 135, maxHp: 550, firstBuff: "Attack +50 (all heroes)", secondBuff: "Dodge +5%", thirdBuff: "Attack +4% (all heroes)", fourthBuff: "Healing Effect of Red Heart +30%", linkImage: "/images/heroes/Jigsaw_Clean.png"})
